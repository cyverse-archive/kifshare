...
install target/kifshare-0.1.1-SNAPSHOT-standalone.jar $RPM_BUILD_ROOT/usr/local/lib/kifshare/
...
%attr(-,iplant,iplant) /usr/local/lib/kifshare/resources/css/
%attr(-,iplant,iplant) /usr/local/lib/kifshare/resources/img/
%attr(-,iplant,iplant) /usr/local/lib/kifshare/resources/flash/
...
%attr(0644,iplant,iplant) /usr/local/lib/kifshare/kifshare-0.1.1-SNAPSHOT-standalone.jar
